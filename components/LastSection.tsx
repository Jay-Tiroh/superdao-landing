...
const LastSection = () => {
  return (
    <div className="text-center flex flex-col items-center gap-5 max-w-210 m-auto p-5">
      <h2 className="last-title text-3xl md:text-4xl">What's your DAO idea?</h2>
      <p className="last-text text-grey6 font-semibold text-xl">
      ...
      <div className="grid items-stretch place-items-center sm:grid-cols-2  justify-center w-full gap-5 text-bg text-sm">
        <div className="flex items-center gap-2 text-start bg-yellow p-3 rounded-xl last-item">
          <Image
        ...
        <div className="flex items-center gap-2 text-start bg-purple-light p-3 rounded-xl last-item">
          <Image
